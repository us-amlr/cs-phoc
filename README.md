...
* phocid_census_amlr_import.R: Script used to import historical US AMLR phocid census data into the Pinnipeds database from Excel files. Requires access to the AMLR_PINNIPEDS database.

* phocid_census_amlr_export.R: Extract phocid census data from the US AMLR Pinnipeds database and write it to 'amlr_data' folder. Requires access to the AMLR_PINNIPEDS database.
