...
* phocid_census_export_usamlr.R: Extract phocid census data from the US AMLR Pinnipeds database and write it to Google Sheets and/or CSV files. Requires access to the AMLR_PINNIPEDS database.
