...
* data: Data relevant to the CS-PHOC project
  ...
  * manuscript: CSV files referenced in the CS-PHOC data paper publication. Created from data in the AMLR_PINNIPEDS database.
  * pre: historical INACH and AMLR data stored in Excel files. These data were imported into the AMLR_PINNIPEDS database via import_inach.R and import_amlr.R. 
  * Raw data stored in the AMLR_PINNIPEDS database can be requested through the authors.
...
* R: The R code for this project
  * import_*.R files: Code for importing INACH and US AMLR data to the AMLR_PINNIPEDS database
