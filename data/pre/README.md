...
The INACH data were extracted from historical INACH records by Renato Borras, and were concatenated together and imported into the AMLR_PINNIPEDS database using the import_inach.R script.
