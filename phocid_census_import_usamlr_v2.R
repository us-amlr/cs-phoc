...
# This is v2, meaning it accounts for the census_phocid_header table
# See here for decisions: https://docs.google.com/document/d/1B3xK8ba0YQE4y3MPw5E04O7IaYOz94DuljDAfA4-7iY
...
#-------------------------------------------------------------------------------
# Import data to AMLR_PINNIPEDS - done 8 March 2022
